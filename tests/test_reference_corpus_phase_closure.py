...
def test_roadmap_and_case_documentation_match_current_semantics() -> None:
    ...
    assert "`S1.P05` is complete" in normalized_roadmap
    assert "`S1.P05.S10` are complete" in normalized_roadmap
    assert "`S1.P06` is active and incomplete" in normalized_roadmap
    assert "`S1.P06.S01` is complete" in normalized_roadmap
    assert "`S1.P06.S02` is complete" in normalized_roadmap
    assert "`S1.P06.S03` is complete" in normalized_roadmap
    assert "`S1.P06.S04` is complete" in normalized_roadmap
    assert "`S1.P06.S05` is complete" in normalized_roadmap
    assert "`S1.P06.S06` is complete" in normalized_roadmap
    assert "`S1.P06.S07` is complete" in normalized_roadmap
    assert "`S1.P06.S08` is complete" in normalized_roadmap
    assert "`S1.P06.S09` is complete" in normalized_roadmap
    assert "`S1.P06.S10` is complete" in normalized_roadmap
    assert "`S1.P06.S11` is complete" in normalized_roadmap
    assert "`S1.P06.S12` is next and not started" in normalized_roadmap
    assert "`S1.P07` through `S1.P10` remain not started" in normalized_roadmap
