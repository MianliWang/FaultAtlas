...
def test_the_package_now_carries_twenty_five_production_modules() -> None:
    """The sealed twenty, and the S01/S02/S03/S04/S05 modules added since.

    The decision's own two counts are sealed historical figures and stay at
    twenty. The checkout has exactly the five named P07 additions.
    """
    inventory = cast(dict[str, Any], _document()["product_inventory"])
