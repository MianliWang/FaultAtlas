...
def test_no_predecessor_production_module_imports_this_one() -> None:
    ...
    `S1.P06.S08` aggregate is excluded because it is a successor rather than a
    predecessor: composing the published values is what it publishes, so it
    imports this module by design.
    """
    predecessors = [
        name
