...
# faultatlas.domain.fault_source_relationship, S1.P06.S05 a sixteenth,
# faultatlas.domain.fault_repair, S1.P06.S06 a seventeenth,
# faultatlas.domain.fault_test, S1.P06.S07 an eighteenth,
# faultatlas.domain.fault_interpretation, S1.P06.S08 a nineteenth,
# faultatlas.domain.fault_instance, and S1.P06.S09 a twentieth,
...
def test_the_roadmap_names_exactly_one_next_gate() -> None:
    ...
    assert claims
    for claim in claims:
        assert "`S1.P06.S12`" in claim, claim
...
def test_the_roadmap_records_the_corpus_and_holds_the_phase_state() -> None:
    ...
    assert "`S1.P06.S12` is next and not started" in text
